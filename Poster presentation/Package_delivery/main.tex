...
\setbeamertemplate{headline}{
 \leavevmode
  \begin{columns}
   \begin{column}{.024\linewidth} 
   \end{column}
   \begin{column}{.2\linewidth}
    \includegraphics[width=0.9\linewidth]{./images/baskin-logo-normal.jpg} %left logo
   \end{column}
   ...
   \end{column}
   \begin{column}{.2\linewidth}
    \includegraphics[width=0.9\linewidth]{./images/hsl-logo.png}   %right logo
   \end{column}
   \vspace{1cm}
  \end{columns}
 \vspace{0.5in}
...
\begin{figure}
\includegraphics[width=0.8\linewidth]{images/crazy-cam.png}
\caption{Crazyflie quadcopter hardware-in-the-loop example}
\end{figure}
