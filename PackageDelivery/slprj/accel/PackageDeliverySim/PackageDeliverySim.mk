...
MASTER_ANCHOR_DIR  = 
START_DIR          = C:/Users/dlavell/Documents/GitHub/Matlab_Sim/PackageDelivery
...
MEX_OPT_FILE       = -f C:/PROGRA~1/MATLAB/R2014b/rtw/c/tools/LCC-WI~1.XML
OPTIMIZATION_FLAGS = -DNDEBUG
ADDITIONAL_LDFLAGS = 

#--------------------------- Model and reference models -----------------------
MODELLIB                  = PackageDeliverySimlib.lib
MODELREF_LINK_LIBS        = 
MODELREF_INC_PATH         = 
...
ADD_INCLUDES = \
	-I$(START_DIR)/slprj/accel/PackageDeliverySim \
	-I$(START_DIR) \
...
LIBS += $(LIBUT) $(LIBMWMATHUTIL) $(LIBMWSL_FILEIO) $(LIBMWIPP) $(LIBMX) $(LIBMEX) $(LIBMWSIGSTREAM)
