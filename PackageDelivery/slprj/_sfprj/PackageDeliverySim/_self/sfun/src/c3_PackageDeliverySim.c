...
static const char * c3_debug_family_names[8] = { "x", "y", "z", "nargin",
  "nargout", "trajectory", "state", "waypoint" };
  ...
  (SFc3_PackageDeliverySimInstanceStruct *chartInstance)
{
  ...
  for (c3_i3 = 0; c3_i3 < 15; c3_i3++) {
    c3_b_trajectory[c3_i3] = (*chartInstance->c3_trajectory)[c3_i3];
  }

  for (c3_i4 = 0; c3_i4 < 18; c3_i4++) {
    c3_b_state[c3_i4] = (*chartInstance->c3_state)[c3_i4];
  }
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_y, 1U, c3_c_sf_marshallOut,
    c3_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_z, 2U, c3_c_sf_marshallOut,
    c3_b_sf_marshallIn);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_nargout, 4U, c3_c_sf_marshallOut,
    c3_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(c3_b_trajectory, 5U, c3_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(c3_b_state, 6U, c3_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c3_b_waypoint, 7U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  CV_EML_FCN(0, 0);
  ...
  for (c3_i5 = 0; c3_i5 < 15; c3_i5++) {
    c3_b_waypoint[c3_i5] = c3_b_trajectory[c3_i5];
  }

  _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, -14);
  _SFD_SYMBOL_SCOPE_POP();
  for (c3_i6 = 0; c3_i6 < 15; c3_i6++) {
    (*chartInstance->c3_waypoint)[c3_i6] = c3_b_waypoint[c3_i6];
  }
  ...
  for (c3_i7 = 0; c3_i7 < 15; c3_i7++) {
    _SFD_DATA_RANGE_CHECK((*chartInstance->c3_waypoint)[c3_i7], 1U);
  }

  for (c3_i8 = 0; c3_i8 < 18; c3_i8++) {
    _SFD_DATA_RANGE_CHECK((*chartInstance->c3_state)[c3_i8], 2U);
  }
}
...
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData)
{
  ...
  for (c3_i9 = 0; c3_i9 < 15; c3_i9++) {
    c3_b_inData[c3_i9] = (*(real_T (*)[15])c3_inData)[c3_i9];
  }

  for (c3_i10 = 0; c3_i10 < 15; c3_i10++) {
  ...
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData)
{
  ...
  for (c3_i12 = 0; c3_i12 < 15; c3_i12++) {
    (*(real_T (*)[15])c3_outData)[c3_i12] = c3_y[c3_i12];
  }
  ...
  *c3_inData)
{
  ...
  for (c3_i13 = 0; c3_i13 < 18; c3_i13++) {
    c3_b_inData[c3_i13] = (*(real_T (*)[18])c3_inData)[c3_i13];
  }
...
static void init_simulink_io_address(SFc3_PackageDeliverySimInstanceStruct
  *chartInstance)
{
  chartInstance->c3_trajectory = (real_T (*)[15])ssGetInputPortSignal_wrapper
    (chartInstance->S, 0);
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2445376177U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(121927048U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3121309996U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(263550801U);
}
...
mxArray *sf_c3_PackageDeliverySim_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("kfWVSfO6kKGCk5D1gEfKVH");
...
static void mdlSetWorkWidths_c3_PackageDeliverySim(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(927811610U));
  ssSetChecksum1(S,(2141849241U));
  ssSetChecksum2(S,(3351607780U));
  ssSetChecksum3(S,(2823156741U));
